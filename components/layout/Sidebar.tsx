...
import { Sparkles, Shirt, LayoutGrid as Layout, Calendar, Settings, Wand as Wand2, Plus } from 'lucide-react';
  ...
  return (
    ...
    >
      ...
      <motion.button
        ...
        whileTap={{ scale: 0.98 }}
        onClick={() => setCurrentPage('outfit-planner')}
        className="w-full mb-6 px-4 py-3 bg-gradient-to-r from-cyan-500 to-blue-500 rounded-xl font-semibold text-white flex items-center justify-center gap-2 hover:shadow-lg hover:shadow-cyan-500/50 transition-all duration-300"
      >
      ...
      <motion.button
        ...
        className={cn(
          'w-full px-4 py-3 rounded-xl flex items-center gap-3 transition-all duration-300 group',
